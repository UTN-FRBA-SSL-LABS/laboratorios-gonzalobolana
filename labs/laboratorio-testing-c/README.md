...
> R:Inicializa el carrito vacio y ya que por cada uso del carrito tendremos distintas cosas sin contar lo que se uso antes.
...
> R:24, en esa parte suma los precios de los items pero le falta multiplicarlo por la cantidad.

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Multiplicar los precios de los items por sus respectivas cantidades.
...
> R:Falla, => esperado 0, obtenido 1  (linea 68) Segmentation fault
...
> R: el operador incorecto es <=, deberia ser <.
